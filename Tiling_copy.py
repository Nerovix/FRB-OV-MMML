...
def data_process(input_folder_path,
    ...
    image_names = [f for f in listdir(input_folder_path) if isfile(join(input_folder_path, f)) and f[-4:] == ".svs"]
...
def multicore(input_folder_path,output_folder_path,start_at_image_name,resolution_level,overlap_percentage,window_size):
    ...
    # print(result) 
    # data_process(input_folder_path,output_folder_path,start_at_image_name,resolution_level,overlap_percentage,window_size)
